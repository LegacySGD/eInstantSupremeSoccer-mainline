...
public class SupremeSoccerCOMEngineManagerTest 
{
	...
	{
		logger = Logger.getLogger(SupremeSoccerCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SupremeFootballIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SupremeFootballIW/InitOutcome.xml").getDocumentElement();
	...
	//@Ignore
	@Test
	public void test_buy_200x_2500000CreditsWin_RevealThreeTimes() throws Exception
	{
		Element playerInput;
		int pricePoint = 200;
	...
	//@Ignore
	@Test
	public void test_try_200x_2500000CreditsWin() throws Exception
	{
		Element playerInput;
		int pricePoint = 200;
